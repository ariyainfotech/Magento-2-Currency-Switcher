...
namespace AriyaInfoTech\CurrencySwitcherPro\Controller\Adminhtml\System;
...
use AriyaInfoTech\CurrencySwitcherPro\Plugin\Datawrapper;
...
class UpdateDb extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            $zipUrl = "https://AriyaInfoTech.com/GeoLite2-Country/GeoLite2-Country.mmdb";
